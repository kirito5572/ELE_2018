...
; 0000 002D     PORTB=(0<<PORTB7) | (0<<PORTB6) | (0<<PORTB5) | (0<<PORTB4) | (0<<PORTB3) | (0<<PORTB2) | (0<<PORTB1) | (0<<PORTB0);
	...
	OUT  0x18,R30
; 0000 002E 
; 0000 002F     // SPI initialization
; 0000 0030     // SPI Type: Slave
; 0000 0031     // SPI Clock Rate: 4000.000 kHz
; 0000 0032     // SPI Clock Phase: Cycle Start
; 0000 0033     // SPI Clock Polarity: Low
; 0000 0034     // SPI Data Order: MSB First
; 0000 0035     SPCR=(0<<SPIE) | (1<<SPE) | (0<<DORD) | (0<<MSTR) | (0<<CPOL) | (0<<CPHA) | (0<<SPR1) | (0<<SPR0);
	LDI  R30,LOW(64)
	OUT  0xD,R30
; 0000 0036     SPSR=(0<<SPI2X);
	LDI  R30,LOW(0)
	OUT  0xE,R30
; 0000 0037 
...
; 0000 0044     while (1) {
_0x3:
; 0000 0045         unsigned char data;
; 0000 0046         data = SPI_Receive();
	SBIW R28,1
;	data -> Y+0
	RCALL _SPI_Receive
	ST   Y,R30
...
; 0000 004D         }
_0x7:
; 0000 004E         lcd_gotoxy(x,y);
_0x6:
	ST   -Y,R17
	MOV  R26,R16
	RCALL _lcd_gotoxy
; 0000 004F         lcd_putchar(data);
	LD   R26,Y
	RCALL _lcd_putchar
; 0000 0050         if(data == 'a') {
	LD   R26,Y
...
; .FEND
;unsigned char SPI_Receive(void) {
; 0000 005F unsigned char SPI_Receive(void) {
_SPI_Receive:
; .FSTART _SPI_Receive
; 0000 0060     while( !(SPSR & (1<<SPIF)));
_0x10:
	SBIS 0xE,7
	RJMP _0x10
; 0000 0061 
; 0000 0062     return SPDR;
	IN   R30,0xF
	RET
; 0000 0063 }
; .FEND
;void led_a() {
; 0000 0064 void led_a() {
_led_a:
; .FSTART _led_a
; 0000 0065 
; 0000 0066 }
